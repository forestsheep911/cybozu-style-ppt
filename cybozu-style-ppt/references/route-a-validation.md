...
- First reusable component asset deck: `cybozu-style-ppt/assets/cybozu-style-components.pptx`
...
The first reusable component deck now exists under `cybozu-style-ppt/assets/`.
