...
const slides = [
  { hash: "/0", file: "00_cover.png" },
  { hash: "/1", file: "01_pain.png" },
  { hash: "/2", file: "02_solution.png" },
  { hash: "/3", file: "03_continue.png" },
];
...
async function main() {
  ...
  try {
    for (const slide of slides) {
      ...
      await page.addStyleTag({ content: ".copy-block, .brand-slot, .page-mark { display: none !important; }" });
